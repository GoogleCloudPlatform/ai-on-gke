# GPU monitoring dashboard. Source: https://github.com/GoogleCloudPlatform/monitoring-dashboard-samples/blob/master/dashboards/nvidia-gpu/nvidia-overview.json
