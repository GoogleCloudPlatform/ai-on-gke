...
variable "benchmark_runner_kubernetes_service_account" {
  description = "Kubernetes Service Account to be used for Benchmark Tool runner"
  type        = string
  default     = "locust-runner-ksa"
}

variable "benchmark_runner_google_service_account" {
  description = "Name for the Google Service Account to be used for Benchmark Tool runner"
  type        = string
  nullable    = false
